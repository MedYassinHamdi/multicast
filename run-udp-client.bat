@echo off
REM ================================================================
REM SCRIPT DE LANCEMENT DU CLIENT UDP
REM ================================================================
REM
REM Ce script lance le client UDP avec interface graphique.
REM
REM PREREQUIS:
...
REM - Ou executer depuis CMD: run-udp-client.bat
...
REM Lancement du client UDP
echo Lancement du client UDP...
echo.
java -cp "target\classes" udp.Client

REM En cas d'erreur
if errorlevel 1 (
    echo.
    echo ERREUR: Le client UDP n'a pas pu demarrer.
